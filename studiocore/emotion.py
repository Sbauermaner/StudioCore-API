...
PUNCT_WEIGHTS = {
    ",": 0.10, ".": 0.30, "!": 0.50, "?": 0.40, "…": 0.60, "—": 0.20, "–": 0.20,
    ":": 0.25, ";": 0.20, '"': 0.05, "'": 0.05, "(": 0.05, ")": 0.05, "[": 0.05, "]": 0.05
}
EMOJI_WEIGHTS = {ch: 0.40 for ch in "♡♥❤❥❣☀☁☂☮☯☾☽★☆✨⚡☼⚔⚖⚙⚗⚛✝✟✞✡☠☢☣❄☃"}


class TruthLovePainEngine:
    """Semantic analyzer for philosophical structure Truth × Love × Pain."""
...
class AutoEmotionalAnalyzer:
    """Detects base emotional spectrum using semantic and punctuation weighting."""
    base_dicts = {
