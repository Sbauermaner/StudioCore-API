...
# Canonical StudioCore version. Legacy labels kept for backward
# compatibility only.
...
DEFAULT_CONFIG = ConfigAccessor(
    {
        ...
        "safety": {
            ...
            # суб - НЧ диапазон, исключаемый из анализа
        ...
        # Task 4.1: Rhythm engine configuration (moved from rhythm.py hardcodes)
        "rhythm": {
            "MIN_BPM": 60.0,
            "MAX_BPM": 180.0,
            "MICRO_MIN": 40.0,
            "MICRO_MAX": 200.0,
            "DEFAULT_BPM": 120.0,
            "BPM_CONFLICT_THRESHOLD": 30.0,
            "HEADER_BPM_WEIGHT": 0.7,
            "ESTIMATED_BPM_WEIGHT": 0.3,
            "EMOTION_WEIGHT": 0.3,
            "AVG_SYLLABLES_THRESHOLD": 8.0,
            "SYLLABLE_DIVISOR": 2.5,
            "SYLLABLE_MULTIPLIER": 0.8,
            "ENERGY_FACTOR_MULTIPLIER": 0.6,
            "ENERGY_FACTOR_CLAMP_MIN": 0.8,
            "ENERGY_FACTOR_CLAMP_MAX": 1.4,
            "ACCEL_BRAKE_MULTIPLIER": 10.0,
            "ACCEL_EMOTION_WEIGHTS": {"anger": 0.7, "epic": 0.6, "joy": 0.3},
            "BRAKE_EMOTION_WEIGHTS": {"sadness": 0.6, "fear": 0.5, "peace": 0.2},
            "PAIN_BOOST_MULTIPLIER": 50.0,
            "LOVE_SMOOTH_MULTIPLIER": 25.0,
            "TRUTH_DRIVE_MULTIPLIER": 20.0,
            "CF_BOOST_MULTIPLIER": 100.0,
            "CF_THRESHOLD": 0.8,
            "DENSITY_BPM_WEIGHT": 0.45,
            "HEURISTIC_BPM_WEIGHT": 0.45,
            "HEURISTIC_BPM_WEIGHT_FALLBACK": 0.65,
            "GLOBAL_DENSITY_WEIGHT": 0.10,
            "ACCENT_HITS_MULTIPLIER": 4.0,
            "DASH_HITS_MULTIPLIER": 0.8,
            "BREATH_PAUSES_MULTIPLIER": 2.0,
            "AVG_WORD_LENGTH_THRESHOLD": 5.5,
            "WORD_LENGTH_MULTIPLIER": 1.7,
            "SHORT_LINES_MULTIPLIER": 2.0,
            "BPM_CLAMP_OFFSET_MIN": 15.0,
            "BPM_CLAMP_OFFSET_MAX": 25.0,
            "PUNCT_ENERGY_MULTIPLIER": 3.5,
            "PUNCT_ENERGY_MAX": 18.0,
            "BASE_BPM_HEURISTIC": 58.0,
            "AVG_WORDS_MULTIPLIER": 3.2,
            "VARIATION_MULTIPLIER": 1.5,
            "PUNCTUATION_HITS_MULTIPLIER": 1.2,
            "ELLIPSIS_HITS_MULTIPLIER": 3.5,
            "LONG_LINES_PENALTY": 1.6,
            "SHORT_LINES_THRESHOLD": 4,
            "LONG_LINES_THRESHOLD": 11,
            "SHORT_SECTION_BPM_BOOST": 4.0,
            "LONG_SECTION_BPM_PENALTY": 3.0,
            "SHORT_SECTION_LINE_COUNT": 4,
            "LONG_SECTION_LINE_COUNT": 16,
            "ESTIMATED_SECTIONS_WEIGHT": 0.65,
            "DENSITY_GLOBAL_WEIGHT": 0.35,
            "COMMA_BREAKS_MULTIPLIER": 0.8,
        },
        # Task 4.2: Punctuation weights (moved from rhythm.py)
        "PUNCT_WEIGHTS": {
            "!": 0.6,
            "?": 0.4,
            ".": 0.1,
...
# ============================================================================
GENRE_WEIGHTS = {
    "semantic_aggression": {"anger_multiplier": 0.4, "conflict_base": 1.0},
    "power_vector": {"bpm_divisor": 180.0, "intensity_multiplier": 0.3},
    "edge_factor": {
        "anger_multiplier": 0.6,
        "tone_intense_boost": 0.3,
        "tone_balanced_boost": 0.15,
    },
    "rhythm_density": {"bpm_divisor": 200.0},
    "narrative_pressure": {"fracture_multiplier": 0.1},
    "poetic_density": {
    ...
    "comedy_factor": {"hits_weight": 0.6, "blob_weight": 0.15, "laughter_weight": 0.1},
    "gothic_factor": {"minor_lumen_multiplier": 0.1},
    "dramatic_weight": {
        "tension_weight": 0.5,
        "gradient_weight": 0.3,
        "pressure_weight": 0.2,
...
if _external_config and _external_config.get("meta", {}).get("auto_load"):
    ...
    # Keywords are kept in separate variables, can be accessed via external
    # config
