# -*- coding: utf-8 -*-
"""
StudioCore v6.0.0 — Maxi Monolith
- Обновлённый loader для rhythm v6 (section-aware)
- Централизованное логирование и Suno-аннотации
- Готов к orchestrator'у StudioCore v6 maxi
"""
...
class StudioCore:
    ...
    def analyze(self, 
        ...
        version = version or self.cfg.get("suno_version", "v6")
...
log.info(f"🔹 [StudioCore {STUDIOCORE_VERSION}] Maxi monolith initialised (Section-Aware Duet Mode v2).")